...
vi.mock('../src/services/api/userApi', () => ({
  ...
  listTrustedDevicesApi: vi.fn().mockResolvedValue({ data: { success: true, data: [] } }),
  revokeTrustedDeviceApi: vi.fn().mockResolvedValue({ data: { success: true, data: null } }),
  revokeAllTrustedDevicesApi: vi.fn().mockResolvedValue({ data: { success: true, data: null } }),
