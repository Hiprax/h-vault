...
| **Audit log**                     | A searchable security log covering **46 distinct operations**, with TTL-based retention.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| `HVAULT_VERSION`       | `0.10.1`          | Image tag for the three first-party images. Keep it equal to `package.json`                                                                        |
